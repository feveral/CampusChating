...
/*
var a = new EncryptManager()
a.aesKey = [ 3, 15, 13, 3, 14, 10, 2, 14, 12, 7, 8, 10, 12, 3, 13, 10 ];
var text = "jaesfoi15wfwesg:qweroijj";
text = a.AESEncrypt(text);
console.log(text);
text = a.AESDecrypt(text);
console.log(text);
*/
